...
StigForge-exported Ansible role **`rhel9_stig`** · release **`0.2.4-private-review`**.
...
```bash
ansible-galaxy role install stigready.rhel9_stig,0.2.4-private-review
```
...
|---|---:|---:|---|---|---|
| `stig` | **94.29%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T100420Z |
