...
StigForge-exported Ansible role **`rhel9_stig`** · release **`0.2.4`**.
...
```bash
ansible-galaxy role install stigready.rhel9_stig,0.2.4
```
...
|---|---:|---:|---|---|---|
| `stig` | **94.29%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260729T223453Z |
